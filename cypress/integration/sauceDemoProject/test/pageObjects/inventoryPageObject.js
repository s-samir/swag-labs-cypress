...
export class InventoryPageObject extends BasePageObject {
    constructor(){
        ...
        this.getSecondaryContainer = e => cy.get(".header_secondary_container").should('be.visible');
        this.verifyProductSortContainerText = e => cy.get(".product_sort_container").contains('Name (A to Z)')
        this.verifySecondaryContainerText = e => cy.get(".header_secondary_container").contains('Products')
        ...
        this.verifySecondaryContainerCart = e => cy.get(".header_secondary_container").contains('Your Cart');
        this.verifySecondaryContainerComplete = e => cy.get(".header_secondary_container").contains('Checkout: Complete!');
